...
public class ModificarCentros extends Frame implements WindowListener, ActionListener, ItemListener {
	...
	Label mensaje = new Label("Seleccionar centro a modificar:");
	...
	public ModificarCentros() {
		setLayout(new FlowLayout());
		setTitle("Modificacion Centros");
		...
		if (aceptar1.equals(actionEvent.getSource())) {
			...
			try {
				...
				statement.executeUpdate(
						"UPDATE Centros SET direccion ='" + direccion.getText() + "' WHERE idCentro='" + idCentro.getText() + "'");
				cerrar = 1;
