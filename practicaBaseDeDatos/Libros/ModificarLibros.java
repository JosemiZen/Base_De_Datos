...
public class ModificarLibros extends Frame implements WindowListener, ActionListener, ItemListener {
		...
		if (aceptar1.equals(actionEvent.getSource())) {
			...
			try {
				...
				statement.executeUpdate(
						"UPDATE Libros SET ISBN ='" + ISBN.getText() + "', nombreLibro ='"+ nombreLibro.getText() +"', anyoLibro='"+ anyoLibro.getText() +"' WHERE idLibro='" + idLibro.getText() + "'");
				cerrar = 1;
