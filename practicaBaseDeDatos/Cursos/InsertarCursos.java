...
public class InsertarCursos extends Frame implements WindowListener, ActionListener, ItemListener {
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		if (aceptar1.equals(actionEvent.getSource())) {
			...
			try {
				...
				statement.executeUpdate("INSERT INTO cursos (nombreCurso, horasCurso) VALUES ('" + nombreCurso.getText()
						+ "', " + horasCurso.getText() + ");");
