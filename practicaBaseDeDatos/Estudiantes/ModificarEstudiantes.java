...
public class ModificarEstudiantes extends Frame implements WindowListener, ActionListener, ItemListener {
	...
	public ModificarEstudiantes() {
		...
		setTitle("Modificacion Estudiantes");
		...
		if (aceptar1.equals(actionEvent.getSource())) {
			...
			try {
				...
				statement.executeUpdate(
						"UPDATE Estudiantes SET nombreAlumno ='" + nombreAlumno.getText() + "', apellidoAlumno ='"
								+ apellidoAlumno.getText() + "', apellido2Alumno ='" + apellido2Alumno.getText()
								+ "', direccionAlumno ='" + direccionAlumno.getText() + "', dniAlumno = '"
								+ dniAlumno.getText() + "' WHERE numExpediente='" + numExpediente.getText() + "'");
				cerrar = 1;
