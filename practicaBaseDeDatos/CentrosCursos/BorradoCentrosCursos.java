...
public class BorradoCentrosCursos extends Frame implements WindowListener, ActionListener, ItemListener {
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		if (aceptar1.equals(actionEvent.getSource())) {
			...
			try {
				...
				statement.executeUpdate("DELETE FROM CentrosCursos WHERE idCursoFK ='" + idCursoFK.getText() + "'");
