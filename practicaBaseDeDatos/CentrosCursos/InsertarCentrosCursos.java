...
public class InsertarCentrosCursos extends Frame implements WindowListener, ActionListener, ItemListener {
	...
	Label lblidCentroFK = new Label("Centro");
	...
	public InsertarCentrosCursos() {
		setLayout(new FlowLayout());
		setTitle("Insertar Centros-Cursos");
		setSize(200, 200);
		setResizable(false);
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		if (aceptar1.equals(actionEvent.getSource())) {
			...
			try {
				...
				statement.executeUpdate("INSERT INTO CentrosCursos (idCentroFK, idCursoFK) VALUES ("+ idCentroFK.getText() + ", "+ idCursoFK.getText() +");");
