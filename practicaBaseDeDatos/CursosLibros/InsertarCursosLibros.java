...
public class InsertarCursosLibros extends Frame implements WindowListener, ActionListener, ItemListener {
	...
	public InsertarCursosLibros() {
		setLayout(new FlowLayout());
		setTitle("Insertar Cursos-Libros");
		setSize(200, 200);
		setResizable(false);
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		if (aceptar1.equals(actionEvent.getSource())) {
			...
			try {
				...
				statement.executeUpdate("INSERT INTO CursosLibros VALUES ("+ idCursoFK.getText() + ", " + idLibroFK.getText() + ");");
