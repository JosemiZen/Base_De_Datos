...
public class ModificarCursosLibros extends Frame implements WindowListener, ActionListener, ItemListener {
	...
	Label mensaje = new Label("Seleccionar libro a modificar:");
	...
	public ModificarCursosLibros() {
		setLayout(new FlowLayout());
		setTitle("Modificacion Libros");
	...
	public Choice recargaCL(Choice lista, Connection connection) {
		lista.removeAll();
		lista.add("Seleccione el libro que cambiara de curso");
		try {
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		if (aceptar1.equals(actionEvent.getSource())) {
			...
			try {
				...
				statement.executeUpdate("UPDATE CursosLibros SET idLibroFK ='" + idLibroFK.getText() + "' WHERE idCursoFK ='" + idCursoFK.getText() + "'");
