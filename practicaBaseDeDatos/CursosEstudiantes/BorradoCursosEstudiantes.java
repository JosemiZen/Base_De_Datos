...
public class BorradoCursosEstudiantes extends Frame implements WindowListener, ActionListener, ItemListener {
	...
	Label mensaje = new Label("Seleccionar estudiante a borrar:");
	...
	public BorradoCursosEstudiantes() {
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		if (aceptar1.equals(actionEvent.getSource())) {
			...
			try {
				...
				statement.executeUpdate("DELETE FROM CursosEstudiantes WHERE numExpedienteFK ='" + numExpedienteFK.getText() + "'");
