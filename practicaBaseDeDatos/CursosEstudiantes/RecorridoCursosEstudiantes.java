...
public class RecorridoCursosEstudiantes extends Frame implements WindowListener, ActionListener {
	...
	Label lblnumExpedienteFK = new Label ("expediente del alumno referenciado");
	...
	String sentencia = "SELECT * FROM cursosestudiantes";
	Connection connection = null;
	Statement statement = null;
	ResultSet rs = null;
	

	public RecorridoCursosEstudiantes() {
		setLayout(new GridLayout(4,2));
		setSize(425, 150);
		setResizable(true);
		setTitle("Tabla Cursos-Estudiantes");
		add(lblCursoFK);
		add(idCursoFK);
	...
	public static void main(String[] args) {
		new RecorridoCursosEstudiantes();
	}
