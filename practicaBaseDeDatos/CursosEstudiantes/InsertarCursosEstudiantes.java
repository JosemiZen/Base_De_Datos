...
public class InsertarCursosEstudiantes extends Frame implements WindowListener, ActionListener, ItemListener {
	...
	Label lblnumExpedienteFK = new Label("Núumero de expediente");
	...
	public InsertarCursosEstudiantes() {
		setLayout(new FlowLayout());
		setTitle("Insertar Cursos-Estudiantes");
		setSize(200, 200);
		setResizable(false);
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		if (aceptar1.equals(actionEvent.getSource())) {
			...
			try {
				...
				statement.executeUpdate("INSERT INTO CursosEstudiantes VALUES ("+ idCursoFK.getText() + ", '" + numExpedienteFK.getText() + "');");
