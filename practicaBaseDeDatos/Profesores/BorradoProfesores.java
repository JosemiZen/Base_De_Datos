...
public class BorradoProfesores extends Frame implements WindowListener, ActionListener, ItemListener {
	...
	Label mensaje = new Label("Seleccionar profesor a borrar:");
	...
	public BorradoProfesores() {
		setLayout(new FlowLayout());
		setTitle("Borrado Profesores");
		...
		if (aceptar1.equals(actionEvent.getSource())) {
			...
			try {
				...
				statement.executeUpdate(
						"DELETE FROM Profesores WHERE dni='" + dni.getText() + "'");
				cerrar = 1;
